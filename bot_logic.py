...
5. 마크다운 볼드체(**), 기울임체(*) 등의 강조 서식을 절대 사용하지 말고 평문으로 작성할 것.
6. 기계적인 DB 카테고리 매핑 설명 등 불필요한 사족은 철저히 생략. 모호할 경우 항공사 문의 권장 추가.
7. 마지막 단락: 출처를 아래 형식의 공식 하이퍼링크로 제공할 것 (단순 텍스트 메타데이터 출력 불가).
...
5. 마크다운 볼드체(**), 기울임체(*) 등의 강조 서식을 절대 사용하지 말고 평문으로 작성할 것.
6. 기계적인 분석 나열은 생략. 확신할 수 없으면 항공사 확인을 권장.
