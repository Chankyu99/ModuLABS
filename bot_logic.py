...
4. 사용자 물품이 DB 항목의 하위 개념일 경우, 어떤 카테고리 규정을 참조했는지 언급
   - 예: "'칼'은 '날 길이 6cm 초과 칼' 규정이 적용됩니다."
5. 불확실한 경우 억측하지 말고 정중히 안내 후 항공사 고객센터 연락 권고
6. 답변의 가장 마지막 줄에 검색된 규정 출처(jurisdiction / stage)를 한 줄로 명시할 것
7. 한국어로 친절하게 답변"""
...
⚠️ 이 답변은 IATA 일반 항공 규정 기반 안내입니다. 정확한 규정은 이용 항공사 또는 [항공보안365](https://www.avsec365.or.kr)에서 확인하세요."""
