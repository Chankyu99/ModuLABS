...
6. 마지막 단락: 출처를 아래 형식의 공식 하이퍼링크로 제공하세요 (단순 텍스트 메타데이터 출력 불가).
...
출처 확인: [항공보안365](https://www.avsec365.or.kr/)
"""
...
⚠️ 정확한 규정은 이용 항공사 또는 [항공보안365](https://www.avsec365.or.kr)에서 확인하세요."""
